...
namespace CIN7Core_MFT_EDI.Models
{
    ...
    {
        private static readonly Dictionary<string, string> CountryISOMap = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        {"Colombia", "CO"}, {"Comoros", "KM"}, {"Congo", "CG"}, {"Congo (Democratic Republic)", "CD"}, {"Costa Rica", "CR"},
        ...
        {
            if (CountryISOMap.TryGetValue(countryName, out string isoCode))
            {
                return isoCode;
            }
